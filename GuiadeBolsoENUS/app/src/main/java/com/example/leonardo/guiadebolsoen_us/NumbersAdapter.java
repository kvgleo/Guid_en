...
public class NumbersAdapter extends ArrayAdapter<Numbers> {
    ...
    public NumbersAdapter(@NonNull Context context, @NonNull List<Numbers> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(listItemView==null){
            listItemView= LayoutInflater.from(getContext()).inflate(R.layout.lista2,parent,false);
        }

        Numbers current = getItem(position);
